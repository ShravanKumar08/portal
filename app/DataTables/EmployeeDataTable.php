            ...
            ->addColumn('action', function ($model) {
                $action = '<div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="' . route('employee.idps',$model->id) . '" class="dropdown-item ' . $this->hasPermissionAccess('employee.idps') . ' " title="Individual Development Plan"><i class="fa fa-envelope"></i>&nbsp;IDP</a>
