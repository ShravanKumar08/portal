            ...
            ->addColumn('action', function ($model) {
                $action = '<div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="' . route('employee.mailoverride',$model->user_id) . '" class="dropdown-item ' . $this->hasPermissionAccess('employee.mailoverride') . ' " title="Override Report Mail"><i class="fa fa-envelope"></i>&nbsp;Override Report Mail</a>
