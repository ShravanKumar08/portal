...
class LectureController extends Controller
{
    public function create()
    {
        ...
        return view('employee.lectures.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('employee/lectures?scope=Self');
    }
    ...
    public function index(LectureDataTable $dataTable, Request $request, Report $report)
    {
        ...
        $data['request'] = $request;
        return $dataTable->addScope(new \App\DataTables\Scopes\BaseDataTableScope)->render('employee.lectures.index', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('employee.lectures.view', $lecture);
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee.lectures.edit', $data);
    }
    ...
    public function status(Request $request)
    {
        ...
        return redirect('employee/lectures?scope=Others');
    }
    ...
    public function list($id)
    {
        ...
        return view('employee.lectures.list', $data);
    }
