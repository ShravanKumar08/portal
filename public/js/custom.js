...
$(function () {
    ...
    // ==============================================================
    // Custom Button Loading function
    // ==============================================================
    $.fn.buttonLoading = function (filter, res) {
        var $this = $(this);
        console.log($this);
        var loadingText = '<i class="fa fa-circle-o-notch fa-spin"></i> loading...';
        if ($this.html() !== loadingText) {
            $this.data('original-text', $(this).html());
            $this.html(loadingText).attr('disabled', true);
        }
    };

    $.fn.buttonReset = function (filter, res) {
        var $this = $(this);
        $this.html($this.data('original-text')).attr('disabled', false);
    };

    $.fn.searchableMultiselect = function() {
        $(this).multiSelect({
            ...
            afterSelect: function(values){
                ...
                if(typeof afterMSSelectCallback == 'function'){
                    afterMSSelectCallback($(this), values);
                }
            },
            afterDeselect: function(values){
                ...
                if(typeof afterMSDeselectCallback == 'function'){
                    afterMSDeselectCallback($(this), values);
                }
            },
        });
    };
