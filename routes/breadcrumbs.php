...
$admin_routes = [
    ...
    'tempcard','lectures',
    'entry', 'officetiming', 'late_entries', 'compensation', 'report', 'officetimingslot', 'platform', 'grade', 'question', "permission","interviewstatus","interviewcall" ,"interviewprescreening", "schedule", "assesment", "teams"
];
