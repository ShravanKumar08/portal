                        ...
                        <div class="form-body">
                                ...
                                @if($is_admin_route)
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('employee_id[]', $trainees_list, $request->employee_id, ['class' => 'form-control selectpicker','multiple data-style' => 'form-control btn-secondary']) }}
                                        </div>
                                    </div>
                                @endif
                                <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-actions">
                                    ...
                                    onclick="location.href ='{{ route('employee.trainee_breaktimings') }}'">
                                        Reset
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered" id='datatable'>
                                ...
                                <tbody>
                                    ...
                                    $data = $employeeHelper->getTraineeBreakTiming($start , $end);
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td>-</td>
                                            @else
                                            <td style='color:red'>{{$data['exceedCount']}}</td>
                                            @endif
                                            <td>{{$data['exceedBreak']}}</td>
                                            @if($data['unusedCount'] == '-')
                                            <td>-</td>
                                            @else
                                            <td style='color:green'>{{$data['unusedCount']}}</td>
                                            @endif
                                            <td>{{$data['unusedBreak']}}</td>
                                            <td>
                                                <button class="btn btn-default btn-view {{ App\Helpers\SecurityHelper::hasAccess('employee.trainee_monthlybreaks') }}" title="View" data-id="{{ $employee->id }}" data-toggle="modal" data-target="#DatatableViewModal"><i class="fa fa-eye"></i></button>
                                            </td>
                                        </tr>
                                    @empty
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#DatatableViewModal').on("shown.bs.modal", function (e) {
                ...
                $.ajax({
                    method: "GET",
                    url: '{{ route('employee.trainee_monthlybreaks') }}',
                    data: {
