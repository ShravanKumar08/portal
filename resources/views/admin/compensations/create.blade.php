...
<div class="row  justify-content-md-center">
    <div class="col-7">
        <div class="card">
            <div class="card-body">
                 <div class="form-body">
                        {{ Form::open(['route' => "compensation.create", 'class' => 'form-horizontal','method' => 'GET']) }}
...
<div id="compensationFormDiv"></div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('select[name="employee_id"]').on('change', function () {
                var eid = $(this).val();
                var $formDiv = $("#compensationFormDiv");

                if(eid){
                    $.ajax({
                        url: "{{ route('compensation.getcompensationform') }}",
                        method: 'GET',
                        data: {
                            employee_id: eid,
                        },
        ...
        $('body').on('change', '.compens_days', function (e) {
            var radioValue = $("input[name='type']:checked").val();
            radioValue === 'P' ?  $('.compen_days_class').hide() :  $('.compen_days_class').show();
        });
