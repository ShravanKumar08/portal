                ...
                <div class="card-body">
                    ...
                    <div class="form-actions">
                        ...
                        @if($request->scope == null)
                            <button type="button" class="btn btn-inverse" onclick="location.href ='{{  route('employee.entry.index') }}'">Reset</button>
                            @else
                            <button type="button" class="btn btn-inverse" onclick="location.href ='{{  route('employee.entry.index').'?scope='.$request->scope }}'">Reset</button>
                       @endif
                    </div>
                    {{ Form::close() }}
                </div>
...
@include('layouts.partials.entry_index_scripts',['entryurl' => url('employee/entry/entryitems')])
@endsection
