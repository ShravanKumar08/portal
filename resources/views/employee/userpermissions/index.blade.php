                ...
                <div class="card-body">
                    ...
                    <div class="form-actions">
                        ...
                        @if($request->scope == null)
                            <button type="button" class="btn btn-inverse" onclick="location.href ='{{  route('employee.userpermission.index') }}'">Reset</button>
                            @else
                            <button type="button" class="btn btn-inverse" onclick="location.href ='{{  route('employee.userpermission.index').'?scope='.$request->scope }}'">Reset</button>     
                        @endif
                    </div>
                    {{ Form::close() }}
                </div>
