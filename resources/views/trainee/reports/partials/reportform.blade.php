    ...
    <div class="row p-t-20">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <button type="button" data-toggle="modal"  data-target="#ProjectNameModal" class="btn btn-xs waves-effect waves-light btn-primary mt-2">Create New Project</button>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['route' => ["trainee.report.createprojectname"],'method' => 'GET', 'class' => 'form-horizontal', 'id' => 'project_create_form']) }}
