                ...
                <div class="row p-t-20">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ Carbon\Carbon::parse($Report->end)->format('H:i A') }}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <strong> Worked Hours: </strong>
                            {{ Carbon\Carbon::parse($Report->workedhours)->format('H:i') }}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <strong> Break Hours: </strong>
                            {{ Carbon\Carbon::parse($Report->breakhours)->format('H:i') }}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <strong> Total Hours: </strong>
                            {{ Carbon\Carbon::parse($Report->totalhours)->format('H:i') }}
                        </div>
                    </div>
                </div>
            </div>
