                ...
                <div class="card-body">
                    ...
                    <div class="form-actions">
                        ...
                        @if($request->scope == null)
                            <button type="button" class="btn btn-inverse" onclick="location.href ='{{  route('trainee.userpermission.index') }}'">Reset</button>
                            @else
                            <button type="button" class="btn btn-inverse" onclick="location.href ='{{  route('trainee.userpermission.index').'?scope='.$request->scope }}'">Reset</button>
