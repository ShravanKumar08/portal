        ...
        <td align="center" class="center" valign="top">
            <center data-parsed="">
                <style class="float-center" type="text/css">
                    ...
                    td.wrapper-inner, td.wrapper-inner th {
                    ...
                    .table-work-details td, .table-work-details th {
                        border: 1px solid #dddddd;
                        text-align: left;
                        padding: 8px;
                    }

                    .table-work-details tr td {
                        font-size: 14px;
                    }

                    .table-work-details tr:nth-child(even) {
                                ...
                                <tr>
                                    <td>
                                        <table class="row collapse">
                                            <tbody>
                                            <tr>
                                                <th class="small-12 large-12 columns first logo-img" valign="middle">
                                                    {{ $header ?? '' }}
                                                </th>
                                            </tr>
                                            </tbody>
